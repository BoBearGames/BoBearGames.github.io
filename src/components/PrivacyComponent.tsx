...
export const PrivacyComponent: React.VFC = () => (
  <div>
    <h2>Privacy Policy</h2>{' '}
    <p>
      {' '}
      Bo Bear Games built the Block Puzzle app as an Ad Supported app. This
      SERVICE is provided by Bo Bear Games at no cost and is intended for use as
      is.
    </p>{' '}
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Block Puzzle unless otherwise
    ...
    <p>
      ...
      <InteractiveLink to={'mailto:support@bobeargames.com'}>
        support@bobeargames.com
      </InteractiveLink>
      .
    </p>
  </div>
