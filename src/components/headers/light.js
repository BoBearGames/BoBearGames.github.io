...
pb-1 border-b-2 border-transparent hover:border-blue-900 hocus:text-blue-900
`;
...
export const NavToggle = tw.button`
  lg:hidden z-20 focus:outline-none hocus:text-blue-900 transition duration-300
`;
